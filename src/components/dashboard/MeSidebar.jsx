...
export default function MeSidebar() {
    ...
    return (
        <aside className="w-48 min-w-[230px] bg-white border-r border-[#e8ede9] flex flex-col h-screen sticky top-0 z-20" aria-label="Personal navigation">
            <div className="flex items-center justify-center gap-2 px-5 py-[18px] pb-4 border-b border-[#e8ede9]">
                <span className="text-lg font-bold text-[#5bb98b] tracking-tight">My Dashboard</span>
            </div>
