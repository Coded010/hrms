...
const FACULTY = [
    { id: "EMP-2023-001", name: "Dr. Sarah Jenkins",    email: "s.jenkins@university.edu",   type: "Full-Time", status: "Active",   initials: "SJ" },
    { id: "EMP-2023-042", name: "Prof. Michael Chen",   email: "m.chen@university.edu",       type: "Part-Time", status: "Active",   initials: "MC" },
    { id: "EMP-2022-115", name: "Dr. Elena Rodriguez",  email: "e.rodriguez@university.edu",  type: "Full-Time", status: "On Leave", initials: "ER" },
    { id: "EMP-2024-008", name: "James Wilson",          email: "j.wilson@university.edu",     type: "Part-Time", status: "Active",   initials: "JW" },
    { id: "EMP-2021-098", name: "Dr. Amanda Lee",        email: "a.lee@university.edu",        type: "Full-Time", status: "Active",   initials: "AL" },
    { id: "EMP-2020-055", name: "Prof. Carlos Reyes",    email: "c.reyes@university.edu",      type: "Full-Time", status: "Active",   initials: "CR" },
    { id: "EMP-2023-077", name: "Dr. Linda Park",        email: "l.park@university.edu",       type: "Part-Time", status: "Active",   initials: "LP" },
    { id: "EMP-2019-033", name: "Prof. David Nguyen",    email: "d.nguyen@university.edu",     type: "Full-Time", status: "On Leave", initials: "DN" },
    { id: "EMP-2024-021", name: "Dr. Maria Santos",      email: "m.santos@university.edu",     type: "Full-Time", status: "Active",   initials: "MS" },
    { id: "EMP-2022-089", name: "Prof. Kevin Torres",    email: "k.torres@university.edu",     type: "Part-Time", status: "Active",   initials: "KT" },
    { id: "EMP-2021-044", name: "Dr. Rachel Kim",         email: "r.kim@university.edu",        type: "Full-Time", status: "Active",   initials: "RK" },
    { id: "EMP-2023-103", name: "Prof. Allan Cruz",       email: "a.cruz@university.edu",       type: "Part-Time", status: "On Leave", initials: "AC" },
    { id: "EMP-2020-067", name: "Dr. Susan White",        email: "s.white@university.edu",      type: "Full-Time", status: "Active",   initials: "SW" },
    { id: "EMP-2024-015", name: "Prof. Brian Lim",        email: "b.lim@university.edu",        type: "Part-Time", status: "Active",   initials: "BL" },
]
    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <button
                    className="inline-flex items-center gap-1.5 rounded-lg border border-[#e5e7eb] bg-white px-3 h-9 text-sm text-[#374151] hover:bg-[#f9fafb] transition-colors"
                >
    ...
    return (
        <div className="flex flex-col gap-5">
            ...
            <div>
                ...
                <h1 className="mt-0.5 text-4xl font-bold text-[#202020] leading-tight">
                    Faculty Management
                </h1>
                ...
                <Table>
                    ...
                    <TableBody>
                        {paginated.map((faculty) => (
                            <TableRow
                                key={faculty.id}
                                className="border-b border-[#f3f4f6] hover:bg-[#fafffe] transition-colors"
                            >
                                ...
                                <TableCell className="py-3">
                                    <EmploymentBadge type={faculty.type} />
                                </TableCell>
